...
<html lang="en">
	...
	<script>(function(d, s, id) {
		...
		<!-- Header -->
			<header id="header">
				<h1><a href="index.html">Nasty Siren</a></h1>
				<nav id="nav">
					<ul>
					...
					<section class="popupBody">
						...
						<div class="social_login">
							<div class="">
								...
								<a href="#" class="social_box google" id="signinButton">
						...
						<div class="user_login">
							<form id="loginForm" action="NormalLogIn" method="post">
								...
								<div class="action_btns">
									...
									<div class="one_half last"><a href="#" class="btn btn_red" onclick="document.getElementById('loginForm').submit()">Login</a></div>
								</div>
							</form>
						...
						<div class="user_register">
							<form id = "myform" action = "NormalSignUp" method="post">
								...
								<div class="checkbox">
									<input id="checkBox" type="checkbox" onclick="swapIt()"/>
									<label for="checkBox" >Show Password</label>
								</div>
			
								<div class="action_btns">
									<div class="one_half"><a href="#" class="btn back_btn"><i class="fa fa-angle-double-left"></i> Back</a></div>
									<div class="one_half last"><a href="#" class="btn btn_red" onclick="document.getElementById('myform').submit()">Register</a></div>
								</div>
							</form>
						</div>
					</section>
				...
				<div class="container">
					...
					<div class="row 200%">
						<section class="4u 12u$(small)">
							...
							<p>Express Your Feelings And Help Others To Cope With Their Daily Life Problems 24/24.</p>
						</section>
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-comments"></i>
							<p>Use Chat Rooms To Meet New People And Share Your Experience. This Utility Allows You Connect Our Website From Wherever You Want.</p>
						</section>
						<section class="4u$ 12u$(small)">
							<i class="icon big rounded fa-user"></i>
							<p>Just Like At Anonymous Meetings You Are Able To Make Video Conference Where You Can Honestly Tell Your Life Stories Help Someone Or Get It For Yourself .</p>
						</section>
					</div>
				</div>
			</section>
			...
			<section id="two" class="wrapper style2 align-center">
				<div class="container">
					<header>
						...
						<p>Then Just Click On Spectate Button To Fully Explore All The Benefits Of Our Website.</p>
					</header>
					<footer>
						<ul class="actions">
							<li>
								<a href="#" class="button alt big">Sign Up</a>
							</li>
							<li>
								<a href="#" class="button alt big">Sign In</a>
							</li>
						</ul>
						<ul class="actions">
							<li>
								<a href="#" class="button alt big">Spectate</a>
							</li>
						</ul>
					</footer>
				</div>
				...
				<div class="container">
					<div class="row">
						<section class="4u 6u(medium) 12u$(small)">
							...
							<p>Look At Some 'Editors Choice' Quotes, They May Change Your Life</p>
							<ul class="alt">
								<li><a href="#">Failure will never overtake me if my determination to succeed is strong enough.</a></li>
								<li><a href="#">No bird soars too high if he soars with his own wings.</a></li>
								<li><a href="#">Things do not happen. Things are made to happen.</a></li>
								<li><a href="#">It does not matter how slowly you go as long as you do not stop.</a></li>
							</ul>
						</section>
						<section class="4u 6u$(medium) 12u$(small)">
							...
							<ul class="alt">
								...
								<li><a href="#">Share Your Experience And Life Problems With Others.</a></li>
								<li><a href="#">Get Support and Become Adviser.</a></li>
								<li><a href="#">Help Others, Make People Happy and Revived.</a></li>
							</ul>
						</section>
						<section class="4u$ 12u$(medium) 12u$(small)">
							...
							<ul class="tabular">
								<li>
									<h3>Address</h3>
									FreeUni<br>
									Aghmashenebeli Xeivani 11
								</li>
								<li>
									<h3>Mail</h3>
									<a href="#">gomia13@freeuni.edu.ge</a>
								</li>
								<li>
									<h3>Phone</h3>
									+995 (598) 721-434
