...
<div id="wrapper">
	...
	<h3>Dashboard</h3>
		...
		<div>
		<h2 align=center style="color:#1CDC26">Category Named By " <%=request.getSession().getAttribute("catName") %> " Has Successfully Been Added To Database</h2>
		<form action="AddNewCategory" method=get style="text-align:center">
			Enter Category Name: <input type="text" name="catName" id="catName" style="text-align:left">
			<br>
			<br>
